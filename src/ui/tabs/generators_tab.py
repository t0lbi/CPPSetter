...
class GeneratorsTab:
    ...
    def _build_ui(self):
        ...
        tk.Button(self.main_frame, text="Create New Generator", bg="#3c3f41", fg="#ffffff", font=("TkDefaultFont",12), command=self.yap).pack(anchor="w", padx=5)
        ...
        tk.Button(gen_frame, text="Edit", bg="#3c3f41", fg="#ffffff", font=("TkDefaultFont",12), command=self.yap).pack(side="left", padx=5)
        tk.Button(gen_frame, text="Upload", bg="#3c3f41", fg="#ffffff", font=("TkDefaultFont",12), command=self.yap).pack(side="left", padx=5)
        tk.Button(gen_frame, text="AI", bg="#3c3f41", fg="#ffffff", font=("TkDefaultFont",12), command=self.yap).pack(side="left", padx=5)
